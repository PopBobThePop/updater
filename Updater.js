// ==UserScript==
// @name         Update CollegeBoard Score
...
(function() {
    'use strict';
    function updateSATScore() {
        var scoreElement = document.querySelector('div[data-qc-id="12CA36D7404B48F5AC14EE130092C5AF:db-tot-score"]');
        scoreElement.innerText = '1600'; // Change this to change total score

        var readingWritingElement = document.querySelector('div[data-qc-id="12CA36D7404B48F5AC14EE130092C5AF:db-Evidence-Based Reading and Writing-score"]');
        readingWritingElement.innerText = '800'; // Change this to change reading & writing score

        var mathElement = document.querySelector('div[data-qc-id="12CA36D7404B48F5AC14EE130092C5AF:db-Math-score"]');
        mathElement.innerText = '800'; // Change this to change math score
    }

    function updatePSATScoreA() {
        var scoreElement = document.querySelector('div[data-qc-id="AC1D8CBBE5DA48539135562926CA4EBD:db-tot-score"]');
        scoreElement.innerText = '1510'; // Change this to change total score

        var readingWritingElement = document.querySelector('div[data-qc-id="AC1D8CBBE5DA48539135562926CA4EBD:db-Evidence-Based Reading and Writing-score"]');
        readingWritingElement.innerText = '750'; // Change this to change reading & writing score

        var mathElement = document.querySelector('div[data-qc-id="AC1D8CBBE5DA48539135562926CA4EBD:db-Math-score"]');
        mathElement.innerText = '760'; // Change this to change math score
    }

    function updatePSATScoreB() {
        var scoreElement = document.querySelector('div[data-qc-id="00A582A41039473E80C014672A44AC70:db-tot-score"]');
        scoreElement.innerText = '1520'; // Change this to change total score

        var readingWritingElement = document.querySelector('div[data-qc-id="00A582A41039473E80C014672A44AC70:db-Evidence-Based Reading and Writing-score"]');
        readingWritingElement.innerText = '760'; // Change this to change reading & writing score

        var mathElement = document.querySelector('div[data-qc-id="00A582A41039473E80C014672A44AC70:db-Math-score"]');
        mathElement.innerText = '760'; // Change this to change math score
    }
    ...
    function main() {
        ...
        if (currentURL == "https://studentscores.collegeboard.org/viewscore") {
            updateSATScore();
            updatePSATScoreA();
            updatePSATScoreB();
    ...
    var checkIntervalA = setInterval(updateSATScore, 0);
    var checkIntervalB = setInterval(updatePSATScoreA, 0);
    var checkIntervalC = setInterval(updatePSATScoreB, 0);
